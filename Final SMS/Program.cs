...
namespace Final_SMS
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped(typeof(IStudentManagementInterface), typeof(SudentManagementServie));
            //builder.Services.AddScoped<IStudentManagementInterface, SudentManagementServie>();
